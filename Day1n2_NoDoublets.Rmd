...
Two Day Samples, 10X Genomics 3'; Seurat v2

# Setup
## Merge Original Seurat Objects
```{r Pineal2_Day1n2 Merge, message=FALSE, results='hide'}
...
```
`r length(Pineal2_Day1n2@var.genes)` variable genes were identified.
...
```
`r length(Pineal2_Day1n2_NonP@var.genes)` variable genes were identified.
