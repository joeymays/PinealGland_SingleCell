...
DimPlot(Pineal2_Day1n2, reduction = 'pca')
...
DimPlot(Pineal2_Day1n2, reduction = 'tsne', label = T, repel = T)+ ggtitle(paste("Day1n2, PCs ", cluster.dims[1],"-",length(cluster.dims),", res = ", cluster.res, sep=''))
DimPlot(Pineal2_Day1n2, reduction = 'tsne', label = T, group.by = "orig.ident", repel = T)
...
DimPlot(Pineal2_Day1n2, reduction = 'tsne', label = T, repel = T)
```
...
DimPlot(Pineal2_Day1n2_NonP, reduction = 'tsne', label = T, repel = T)
```
## Identify Highly Variable Genes
...
DimPlot(Pineal2_Day1n2_NonP, reduction = 'pca')
...
DimPlot(Pineal2_Day1n2_NonP, reduction = 'tsne', label = T, repel= T) + ggtitle(paste("Day1n2 - Non-pinealocytes, PCs ", cluster.dims[1],"-",length(cluster.dims),", res = ", cluster.res, sep=''))
DimPlot(Pineal2_Day1n2_NonP, reduction = 'tsne', label = T, group.by = "orig.ident", repel = T)
DimPlot(Pineal2_Day1n2_NonP, reduction = 'tsne', label = T, group.by = "major.types", repel = T)
```
