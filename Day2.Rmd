---
title: "DK Pineal2 Day 2 10X Seurat v2"
author: "Joseph Mays"
output:
...
```{r Pineal2_Day2 Import, results="hide"}
Pineal2_Day2.matrix <- Read10X(data.dir = "../Results/Day2/filtered_gene_bc_matrices/Rnor6.0.90_10X/")
Pineal2_Day2 <- CreateSeuratObject(Pineal2_Day2.matrix, project = "Pineal2_Day2", min.cells = 2, min.genes = 800)
#4 cells have less than 800 genes
...
GenePlot(Pineal2_Day2, "nUMI", "nGene")
#Pineal2_Day2 <- FilterCells(Pineal2_Day2, subset.names = "percent.mito", high.thresholds = 0.05)
...
PCElbowPlot(Pineal2_Day2, num.pc = 50)
#JackStraw(Pineal2_Day2, num.pc = 30)
